...
async def lifespan(app: FastAPI):
    # Schema é criado/atualizado via `alembic upgrade head` (rodar antes
    # de subir a aplicação) — não mais aqui. Base.metadata.create_all()
    # só criava tabela nova, nunca alterava uma existente; era fácil
    # esquecer de aplicar uma coluna nova em produção (ver histórico do
    # README). Ver alembic/versions/ e README para o fluxo de migração.
    start_scheduler()
    yield
